        ...
        <div class="nav-bar">
          ...
          <div class="mobile-nav-bar" v-show="isShowMobileNavBar">
            <ul>
              ...
              <li @click="about" v-bind:class="{current: $route.path== '/about'}">
                <span style="border-left: 1px solid #ddd;">关于我</span>
              </li>
            </ul>
          </div>
          <div class="nav-bar-body">
            <ul>
              ...
              <li @click="about" v-bind:class="{borderRightActive: $route.path=='/about'}">关于我</li>
            </ul>
          </div>
          <div class="nav-bar-footer">
            <span>@Bingmangtech</span>
          </div>
        </div>
      </el-col>
